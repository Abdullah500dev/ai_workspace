...
export default function ConnectApps() {
  ...
  return (
    <div className="max-w-4xl mx-auto text-center py-12">
      <h2 className="text-2xl font-semibold mb-4 text-black">Connect Your Tools</h2>
      <div className="flex flex-wrap justify-center gap-4">
        {apps.map((app, i) => (
          <button
            key={i}
            className="flex items-center gap-2 px-4 py-2 border rounded shadow text-black hover:bg-blue-50"
          >
